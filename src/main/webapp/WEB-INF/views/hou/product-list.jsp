...
<div >
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="product_add('添加产品','product-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a></span> <span class="r">共有数据：<strong>${total}</strong> 条</span> </div>
		<div class="mt-20">
			<table id="table1" class="display table table-border table-bordered table-bg table-hover table-sort">
				<thead>
					<tr class="text-c">
				...
				<tbody>
					<!--
					<c:forEach var="item" items="${productInfos}" varStatus="status">
...
$(document).ready(function(){
	...
	*/
	dtable=$('#table1').dataTable( {
        ...
        "bDestroy" : true,  
        "bSortCellsTop" : true,  
        "sAjaxSource" : "loadProductList.html",  
        "sScrollY": "100%",  
